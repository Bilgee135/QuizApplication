...
import customization.ColorChoice;
import customization.StyleButton;
...
public class Leaderboard extends JPanel {
    ...
    public Leaderboard(CardLayout cardLayout, JPanel cardPanel, UserAuthentication userAuth) {
        ...
        contentPanel.setBackground(ColorChoice.BACKGROUND);
        ...
        StyleButton.styleButton(backButton, 200);
...
//        String attemptIdentifier = (parts.length > 3) ? parts[2] : null; // Could be used to track specific attempts if needed
    ...
    private JPanel createLatestAttemptsPanel() {
        ...
        panel.setBackground(ColorChoice.BACKGROUND);
        ...
        for (Map.Entry<String, List<ScoreAttempt>> entry : latestAttempts.entrySet()) {
            ...
            for (ScoreAttempt attempt : attempts) {
                ...
                attemptLabel.setForeground(ColorChoice.BUTTON_FOREGROUND);
